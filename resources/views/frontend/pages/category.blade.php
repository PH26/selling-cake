                            ...
                            <aside class="ps-widget ps-widget--sidebar ps-widget--category">
                                ...
                                <div class="ps-widget__content">
                                    <ul class="ps-list--circle">
                                        <li class="current"><a href="product-listing.html"><span class="circle"></span>All category </a></li>
                                        @foreach($categories as $category)
                                        <li><a href="product-listing.html"><span class="circle"></span>{{$category->name}}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </aside>
                            ...
                            <aside class="ps-widget ps-widget--sidebar ps-widget--best-seller">
                                ...
                                <div class="ps-widget__content">
                                    <div class="ps-product--sidebar">
                                        ...
                                        <div class="ps-product__thumbnail">
                                            <a class="ps-product__overlay" href="product-detail.html"></a><img src="upload/products/{{$bestseller->image}}" alt=""></div>
                                        <div class="ps-product__content">
                                            <h4 class="ps-product__title"><a href="product-detail.html">{{$bestseller->name}}</a></h4>
