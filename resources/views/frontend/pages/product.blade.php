            ...
            <div class="ps-product--detail">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                        <header>
                            ...
                            <div class="ps-product__shop">
                                <div class="form-group--number">
                                    ...
                                    <input class="form-control" data-quantity={{$product->quantity}} type="text" value="1">
                        ...
                        <footer>
                            <div class="row">
                                <div class="col-lg-6 col-md-5 col-sm-6 col-xs-12 "><a class="ps-btn--fullwidth ps-btn">Add To Cart<i class="fa fa-angle-right"></i></a>
                                </div>
