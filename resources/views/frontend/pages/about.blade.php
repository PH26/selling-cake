                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                        ...
                        <div class="ps-section__content text-center">
                            ...
                            <div class="ps-about__sign text-center mb-30 mt-40"><img src="frontend/images/about/1.png" alt=""></div>
                            <p class="ps-about-sign">CEO - Vanila Bakery Shop</p>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 "><img src="frontend/images/about/2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                            <div class="ps-award text-center">
                                <div class="ps-award__icon"><img src="frontend/images/award/01.png" alt=""></div>
                                <div class="ps-award__content">
                                    <h3>BAKERY OF THE YEAR</h3><span>2010 - 2012</span>
                                    <p>Tart bear claw cake tiramisu chocolate bar gummies dragée lemon drops brownie. Jujubes chocolate cake sesame snaps</p><a class="ps-btn ps-btn--xs" href="#">Read more</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                            <div class="ps-award text-center">
                                <div class="ps-award__icon"><img src="frontend/images/award/02.png" alt=""></div>
                                <div class="ps-award__content">
                ...
                <div class="ps-section__content">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                            <article class="ps-people ps-people--2">
                                ...
                                <div class="ps-people__content">
                                    <h4>Juan Olson</h4><span class="ps-people__position">CEO - Founder</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                            <article class="ps-people ps-people--2">
                                <div class="ps-people__thumbnail">
                                    <a class="ps-people__overlay" href="#"></a><img src="frontend/images/team/team-3.jpg" alt=""></div>
                                <div class="ps-people__content">
