...
<div class="page-header">
	<h1><a href="admin/slide/index"><i class="ace-icon fa fa-arrow-circle-left"></i></a>&nbsp;Add Slide</h1>
</div>
<!-- /.page-header -->
<div class="row">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal" role="form" action="admin/slide/add" method='POST' enctype='multipart/form-data'>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name='link' placeholder="Image link" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="form-group">
