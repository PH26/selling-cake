...
<div class="page-header">
	<h1><a href="admin/category/index"><i class="ace-icon fa fa-arrow-circle-left"></i></a>&nbsp;Edit Category
		<small>
...
<div class="row">
		...
		<form class="form-horizontal" role="form" action="admin/category/edit/{{$category->id}}" method='POST'>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name='name' value="{{$category->name}}" class="col-xs-10 col-sm-5" />
					@if ($errors->has('name'))
