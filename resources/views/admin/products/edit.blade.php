...
<h1><a href="admin/product/index"><i class="ace-icon fa fa-arrow-circle-left"></i></a>&nbsp;Edit Product
	<small>
		...
		<form class="form-horizontal" role="form" action="admin/product/edit/{{$product->id}}" method='POST' enctype='multipart/form-data'>
				...
				<div class="col-sm-4">
					<div class="widget-body">
						<div class="widget-main" style="position:relative; left:-11px; top:-10px">
							<input name='unit_price' type="number" step=10000 class="input-sm" value="{{$product->unit_price }}"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="widget-body">
						<div class="widget-main" style="position:relative; left:-11px; top:-10px;">
							<input name='promote_price' type="number" step=10000 class="input-sm" value="{{$product->promote_price}}"/>
							<div class="space-6"></div>
						</div>
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="widget-body">
						<div class="widget-main" style="position:relative; left:-11px; top:-10px;">
							<input name='quantity' type="number" step=1 value="{{ $product->quantity }}"/>
							<div class="space-6"></div>
