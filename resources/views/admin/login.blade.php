...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="admin_asset/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="admin_asset/css/ace-part2.min.css" />
		<![endif]-->
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            {{ csrf_field() }}
												<fieldset>
													<label class="block clearfix form-group{{ $errors->has('email') ? ' has-error' : '' }}">
													...
													<label class="block clearfix form-group{{ $errors->has('password') ? ' has-error' : '' }}">
														<span class="block input-icon input-icon-right">
